...
# mycursor.execute("SELECT * FROM cards where id in (%s,%s,%s,%s,%s)", [19,20,23,25,31])
...
# parameter = nn.neuron_network(dt.T, y.reshape((1, y.shape[0])), n_iter=800)
